...
- **Formulario de ingreso de historial médico:**
  ...
  - ![Ingreso de historial médico - Formulario de ingreso](https://github.com/upc-pre-202302-IoTheraphy-SI572-SW71/ReportAssets/blob/main/mobileTheraphyPhotos/PatientsList.png?raw=true)
