...
A continuación presentamos los Bounded Context Canvas que nos permiten conocer a mayor detalle cómo se relacionan los bounded context.<br><br>
		El User Management Context se enfoca en la gestión de datos de usuarios, asegurando su privacidad y garantizando que solo accedan y utilicen la información que les pertenece. En esencia, este contexto desempeña un papel fundamental en el proceso de inicio de sesión dentro de Therapy, asegurando la integridad de los datos y la confidencialidad de los usuarios, lo que resulta crucial para brindar una experiencia segura y confiable en nuestra plataforma.<br><br>
		...
		El Physiotherapist Selection and Review Management Context se dedica a facilitar la gestión de pacientes en su búsqueda y elección de fisioterapeutas, además de proporcionar la capacidad de calificar a estos profesionales. En otras palabras, este contexto se erige como una pieza fundamental para garantizar que los pacientes encuentren fácilmente a los fisioterapeutas que necesitan y tengan la oportunidad de evaluar su experiencia, contribuyendo así a una atención médica más informada y eficiente en el entorno de Therapy. <br><br>
  		<img src="https://raw.githubusercontent.com/upc-pre-202302-IoTheraphy-SI572-SW71/ReportAssets/main/Bound%20Contexts/EventStorming%20-%20Frame%2012%20(1).jpg" width="600"><br><br>
    		El Patient Engagement and Therapy Coordination Management Context se centra en supervisar y facilitar el tratamiento de los pacientes, incluyendo terapia en video, programación de citas y análisis de resultados. En esencia, este contexto es fundamental para garantizar un control efectivo del tratamiento de los pacientes, proporcionando recursos educativos, organizando citas y permitiendo una evaluación profunda de los resultados, lo que mejora significativamente la atención médica en Therapy. <br><br>
    		<img src="https://raw.githubusercontent.com/upc-pre-202302-IoTheraphy-SI572-SW71/ReportAssets/main/Bound%20Contexts/EventStorming%20-%20Frame%2012%20(2).jpg" width="600"><br><br>
      		El Health Records and Expertise Management Context está diseñado para administrar información clave de usuarios, tanto pacientes como fisioterapeutas. En otras palabras, este contexto se erige como un componente esencial para garantizar la gestión eficiente de los datos fundamentales de nuestros usuarios, lo que contribuye a una atención médica más precisa y personalizada dentro de la plataforma de Therapy. <br><br>
		...
		El Payment Management Context se fundamenta en el control de pagos dentro de la aplicación, realizado por los pacientes al reservar sus citas médicas. En esencia, este contexto desempeña un papel crítico al asegurar la gestión precisa y segura de los pagos realizados por los usuarios, contribuyendo a una experiencia de reserva de citas fluida y confiable en la plataforma de Therapy. <br><br>
